...
const ConflictStartPage: React.FC<ConflictStartPageProps> = () => {
  ...
  const [intakeContextChanged, setIntakeContextChanged] = useState(false);
  ...
  // Fetch user's profile setting for intake context on mount
  useEffect(() => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/conflicts`, {
        ...
        body: JSON.stringify({
          ...
          guidanceMode,
          // Only send useIntakeContext if user explicitly changed it
          useIntakeContext: intakeContextChanged ? useIntakeContext : undefined
        })
      });
          ...
          <div className="form-group">
            <label className="privacy-toggle">
              <input
                ...
                onChange={(e) => {
                  setUseIntakeContext(e.target.checked);
                  setIntakeContextChanged(true);
                }}
                disabled={isSubmitting}
                className="privacy-checkbox"
              />
              <span className="privacy-label">
                ...
                <span className="privacy-description">
                  Include your intake interview information for more personalized guidance
                </span>
              </span>
            </label>
          </div>
